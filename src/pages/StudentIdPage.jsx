  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col p-4 text-black">
      ...
      <div className="flex-grow flex flex-col items-center">
        ...
        <h1 className="text-xl  font-semibold mb-6">Felipy Seleguim da Silva</h1>
        
        <div className="w-full max-w-xs grid grid-cols-2 gap-y-4 mb-6">
          <div>
            <p className="text-xs text-gray-500">CPF</p>
            <p className="text-sm">084.884.619-25</p>
          </div>
          <div>
            <p className="text-xs text-gray-500">Nascimento</p>
            <p className="text-sm">03 Mar 1999</p>
          </div>
          <div>
        ...
        <div className="w-full max-w-xs mb-8">
          ...
          <p className="text-sm">LONDRINA</p>
        </div>
