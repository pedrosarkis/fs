    ...
    <div className="flex flex-col min-h-screen">
      <div className="bg-blue-600 text-white pb-0 mt-10 relative">
        <div className="flex flex-col items-center mt-4">
          ...
          <h2 className="text-xl font-bold mt-2">Felipy Seleguim da Silva</h2>
          <p className="text-sm mt-3">felipyseleguim@hotmail.com</p>
          <p className="text-sm mt-1 font-bold">(48)98454-0246</p>
        </div>
